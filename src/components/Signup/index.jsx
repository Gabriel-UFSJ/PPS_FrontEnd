        ...
        <div className="flex items-center justify-center w-screen h-screen bg-gradient-to-b from-blue-500 to-blue-800">
            <Card className="w-full max-w-[20rem] p-8 shadow-xl shadow-blue-gray-900/5 bg-white rounded-lg">
                <div className="flex flex-col items-center mb-8">
                    <Typography variant="h6" color="blue-gray" className="mb-4">Create an account</Typography>
                    <a href="/">
                        <img src={brandDark} alt="brand" className="h-20 w-20 object-contain mb-4" />
                    </a>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <Typography variant="h6" color="blue-gray" className="mb-1">Password</Typography>
                        <input
                            type="password"
                            value={password}
                    ...
                    <div>
                        <Typography variant="h6" color="blue-gray" className="mb-1">Confirm password</Typography>
                        <input
                            type="password"
